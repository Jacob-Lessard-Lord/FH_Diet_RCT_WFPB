...
model_ldlc <- lmer_reg_strat(data_post_itt, "ldlc", "seq", "ldlc ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(ldlc ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
...
# Modèle + résultats du modèle
model_ldlc_lpa_corr <- lmer_reg_strat(data_post_itt, "ldlc_lpa_corr", "seq", "ldlc_lpa_corr ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(ldlc_lpa_corr ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_chol <- lmer_reg_strat(data_post_itt, "chol", "seq", "chol ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(chol ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_hdlc <- lmer_reg_strat(data_post_itt, "hdlc", "seq", "hdlc ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(hdlc ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_tg <- lmer_reg_strat_log(data_post_itt, "tg", "seq", "log(tg) ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(tg ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_nhdlc <- lmer_reg_strat(data_post_itt, "nhdlc", "seq", "nhdlc ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(nhdlc ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_apoa1_neph <- lmer_reg_strat(data_post_itt, "apoa1_neph", "seq", "apoa1_neph ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(apoa1_neph ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_apob_neph <- lmer_reg_strat(data_post_itt, "apob_neph", "seq", "apob_neph ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(apob_neph ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_lpa_neph <- lmer_reg_strat(data_post_itt, "lpa_neph", "seq", "lpa_neph ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(lpa_neph ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_crp_neph <- lmer_reg_strat_log(data_post_itt, "crp_neph", "seq", "log(crp_neph) ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(log(crp_neph) ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_glufast <- lmer_reg_strat(data_post_itt, "glufast", "seq", "glufast ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(glufast ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_ins2018 <- lmer_reg_strat(data_post_itt, "ins2018", "seq", "ins2018 ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(ins2018 ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_hba1c <- lmer_reg_strat(data_post_itt, "hba1c", "seq", "hba1c ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(hba1c ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_sbp <- lmer_reg_strat(data_post_itt, "sbp", "seq", "sbp ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(sbp ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
# Modèle + résultats du modèle
model_dbp <- lmer_reg_strat(data_post_itt, "dbp", "seq", "dbp ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(dbp ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
model_ten_year_risk_ascvd <- lmer_reg_strat_log(data_post_itt, "ten_year_risk_ascvd", "seq",
                                                "log(ten_year_risk_ascvd) ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat)")

# Validation des hypothèses du modèle
plot(influence(lmer(ten_year_risk_ascvd ~ tx*seq +  tx + age + sex + hfgenotype + seq + bmi + weight_delta + (1|nomat),
                    data = data_post_itt, REML = TRUE), obs = TRUE), which = "cook") # Distance de Cook
...
write.xlsx(results_reg, file = "Table S8.xlsx")
